...
print("somePlace.latitude = \(somePlace.latitude), somePlace.longitude = \(somePlace.longitude)")
/*:
...
var favoriteBook = Book(title: "Harry Potter", author: "JK Rowling", pages: 500, price: 24.99)
print("Your favorite book, \(favoriteBook.title), by \(favoriteBook.author), is \(favoriteBook.pages) pages long, and costs \(favoriteBook.price)")
/*:
...
struct Height {
    ...
    init(heightInInches: Double) {
        ...
        self.heightInCentimeters = heightInInches * inchesToCentimeters
    }
    
    init(heightInCentimeters: Double) {
        self.heightInInches = heightInCentimeters / inchesToCentimeters
 ...
 */
var myHeight = Height(heightInCentimeters: 167.64)
