 ...
 */
var scottNakada = User(name: "Scott Nakada", age: 62, height: 66, weight: 223, activityLevel: 0)
print("""
    Name: \(scottNakada.name)
    Age: \(scottNakada.age)
    Height: \(scottNakada.height)
    Weight: \(scottNakada.weight)
    Activity Level: \(scottNakada.activityLevel)
""")
/*:
...
struct Distance {
    ...
    init(feet: Double) {
        self.feet = feet
        self.meters = feet/metersToFeet
    }
    
    init(meters: Double) {
        self.feet = meters * metersToFeet
        self.meters = meters
    }
}
 ...
 */
var meter = Distance(feet: 3.28084)
print(meter.meters)
print(meter.feet)
