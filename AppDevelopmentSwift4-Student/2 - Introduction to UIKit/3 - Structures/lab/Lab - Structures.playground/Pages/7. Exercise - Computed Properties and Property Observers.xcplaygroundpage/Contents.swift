...
var myRect = Rectangle(width: 2, height: 4)
print(myRect.area)
/*:
...
struct Height {
    ...
    func display() {
        print("""
            Height In Inches: \(self.heightInInches)
            Height In Centimeters: \(self.heightInCentimeters)
            """)
    }
}

var tall = Height(heightInInches: 66)
tall.display()
tall.heightInInches = 1
tall.display()
tall.heightInCentimeters = 25.4
tall.display()
