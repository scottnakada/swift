 ...
 */
struct User {
    static var currentUser = User(userName: "Scott Nakada", email: "scottnakada@gmail.com", age: 62)
 ...
 */
var victor = User(userName: "Victor Nakada", email: "victornakada@gmail.com", age: 27)
User.logIn(user: victor)
